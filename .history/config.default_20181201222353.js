...
var config = {
  ...
  name: 'Angular 开发者社区', // 社区名字
  description: 'Angular 开发者社区', // 社区的描述
  keywords: 'angular,angular4,angular-cli,nodejs, node, express, connect, socket.io',
