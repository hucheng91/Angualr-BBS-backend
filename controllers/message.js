...
exports.index = function (req, res, next) {
  ...
  ep.all('has_read_messages', 'hasnot_read_messages', function (has_read_messages, hasnot_read_messages) {
    ...
    res.send({has_read_messages: has_read_messages, hasnot_read_messages: hasnot_read_messages});
      Message.updateMessagesToRead(user_id, hasnot_read_messages);
  });
    ...
    [has_read, unread].forEach(function (msgs, idx) {
      ...
      epfill.after('message_ready', msgs.length, function (docs) {
        ...
        docs = docs.map(function (doc) {
            ...
            doc.reply.content = md.render(at.linkUsers(doc.reply.content));
